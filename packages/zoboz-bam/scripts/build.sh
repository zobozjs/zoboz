...
docker run -it --rm --platform linux/arm64 \
  ...
  bash -c "
    ...
    /app/target/aarch64-unknown-linux-musl/release/zoboz-bam /app/bin/binaries/zoboz-bam-linux-arm64
"
...
docker run -it --rm --platform linux/amd64 \
  ...
  bash -c "
    ...
    /app/target/x86_64-unknown-linux-musl/release/zoboz-bam /app/bin/binaries/zoboz-bam-linux-x64
"
