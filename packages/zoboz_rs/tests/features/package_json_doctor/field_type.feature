Feature: Ensure field "type" is not present
  ...
  Scenario: When field "type" is not present, no change request is requested
  ...
  Scenario: When field "type" is not present, no change will happen to package.json
    Given there is an npm package with:
      """
      {
        "name": "test",
  ...
  Scenario: When field "type" is present, removal is requested
    Given there is an npm package with:
      """
      {
        "name": "test",
